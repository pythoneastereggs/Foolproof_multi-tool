...
# που θα χρησιμοποιηθεί ποιο μετά για να γίνει update στο σύστημα
echo "[System_properties]" > $(pwd)/applications-tools/linux-tools/tools/system_update/sys_update.ini
echo "distro_based = $distro_based" >> $(pwd)/applications-tools/linux-tools/tools/system_update/sys_update.ini
echo "package_manager_apt = $flag_apt" >> $(pwd)/applications-tools/linux-tools/tools/system_update/sys_update.ini
echo "package_manager_flatpak = $flag_flatpak" >> $(pwd)/applications-tools/linux-tools/tools/system_update/sys_update.ini
echo "package_manager_snap = $flag_snap" >> $(pwd)/applications-tools/linux-tools/tools/system_update/sys_update.ini
echo "package_manager_pacman = $flag_pacman" >> $(pwd)/applications-tools/linux-tools/tools/system_update/sys_update.ini