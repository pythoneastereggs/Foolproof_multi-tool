...
Here is what i got for you:
    ...
    0- exit""")
        ...
        if users_input == 0:
            ...
            os.system("python3 -u $(pwd)/applications_tools/games/2048/puzzle.py")
        elif users_input == 2:
            coin_flip()
        elif users_input == 3:
            Hangman_game()
        elif users_input == 4:
            os.system("python3 -u $(pwd)/applications_tools/games/Pong/Main_Pong.py")
        elif users_input == 5:
            DiceRoller()
        elif users_input == 6:
            os.system("python3 -u $(pwd)/applications_tools/games/Tic_Tac_Toe/Tic_Tac_Toe.py")
